...
namespace InspectionAPI.Controllers
{
    ...
    public class InspectionTypesController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<InspectionType>>> GetInspectionsTypes()
        {
            return await _context.InspectionsTypes.ToListAsync();
        }
        ...
        {
            var inspectionType = await _context.InspectionsTypes.FindAsync(id);
        ...
        {
            _context.InspectionsTypes.Add(inspectionType);
            await _context.SaveChangesAsync();
        ...
        public async Task<IActionResult> DeleteInspectionType(int id)
        {
            ...
            _context.InspectionsTypes.Remove(inspectionType);
            await _context.SaveChangesAsync();
        ...
        {
            return _context.InspectionsTypes.Any(e => e.Id == id);
        }
    }
}
